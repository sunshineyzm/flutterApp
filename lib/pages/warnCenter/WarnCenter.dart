...
class WarnCenter extends StatefulWidget {

  _WarnCenterState createState() => _WarnCenterState();
}

class _WarnCenterState extends State<WarnCenter> with SingleTickerProviderStateMixin{
  List _tabTitles = ['实时', '历史'];
                  ...
                  child: new Container(
                    ...
                    child: new Row(
                      ...
                      children: <Widget>[
                        ...
                        new Text('警情中心', style: new TextStyle(fontSize: 20.0, color: Colors.white, fontWeight: FontWeight.w400)),
