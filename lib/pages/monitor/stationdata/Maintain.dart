...
class _MaintainState extends State<Maintain> {
  ...
  List maintain = [
    {'info': 'N6000-5 VOC在线分析仪维修完成',  'status': '正常',},
    {'info': 'N6000-5 VOC在线分析仪停用，待维修', 'status': '待维修',},
    {'info': 'N6000-5 VOC在线分析仪维修完成',  'status': '正常',},
    {'info': 'N6000-5 VOC在线分析仪停用，待维修', 'status': '待维修',},
    {'info': 'N6000-5 VOC在线分析仪维修完成',  'status': '正常',},
    {'info': 'N6000-5 VOC在线分析仪停用，待维修', 'status': '待维修',},
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: <Widget>[
        ...
        // 内容
        maintainWidget(context),
      ]
    );
  }

  Widget maintainWidget(BuildContext context) {
    List<Widget> tiles = [];
    Widget content;
    for (var item in this.maintain) {
